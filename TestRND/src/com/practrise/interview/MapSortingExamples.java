...
public class MapSortingExamples {
    ...
    private static void sortByKeyJava8Stream() 
    {
        ...
        unSortedMap.entrySet().stream().sorted(Map.Entry.comparingByValue()) // for Keys use Map.Entry.comparingByKey
                .forEachOrdered(x -> sortedMap.put(x.getKey(), x.getValue()));
         
        System.out.println("Sorted Map   : " + sortedMap);
         
        LinkedHashMap<String, Integer> reverseSortedMap = new LinkedHashMap<>();
        unSortedMap.entrySet().stream().sorted(Map.Entry.comparingByKey(Comparator.reverseOrder()))  //for values use Map.Entry.comparingByValues
