...
// User defined class 
	...
	public  class Student { 
		...
		{ 
			...
			/*
			 * final int temp = 14; int ans = 1; ans = temp * ans + rollno;
			 */
			return 1; 
		} 
		...
		{ 
			/*
			 * if (this == o) { return true; } if (o == null) { return false; } if
			 * (this.getClass() != o.getClass()) { return false; } Student other =
			 * (Student)o; if (this.rollno != other.rollno) { return false; }
			 */
			return false; 
		} 
